 ...
 * @since  1.6
 */
class CoolcineplanTableuser extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_coolcineplan.user.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_coolcineplan/access.xml',
				"/access/section[@name='user']/"
			);
			$default_actions = JAccess::getAssetRules('com_coolcineplan.user.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_coolcineplan.user.' . (int) $this->$k;
	}
