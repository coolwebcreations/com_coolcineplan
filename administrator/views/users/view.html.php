 ...
 * @since  1.6
 */
class CoolcineplanViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CoolcineplanHelpersCoolcineplan::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_COOLCINEPLAN_TITLE_USERS'), 'users.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_coolcineplan&view=users');
