...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_coolcineplan&task=showings.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'showingList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
			...
			<table class="table table-striped" id="showingList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'showings.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
