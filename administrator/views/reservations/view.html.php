 ...
 * @since  1.6
 */
class CoolcineplanViewReservations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CoolcineplanHelpersCoolcineplan::addSubmenu('reservations');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_COOLCINEPLAN_TITLE_RESERVATIONS'), 'reservations.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				JToolbarHelper::custom('reservations.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
			}
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			{
				JToolBarHelper::custom('reservations.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
			}
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_coolcineplan&view=reservations');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`show_id`' => JText::_('COM_COOLCINEPLAN_RESERVATIONS_SHOW_ID'),
		);
	}
}
