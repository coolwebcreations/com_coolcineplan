 ...
 * @since  1.6
 */
class CoolcineplanViewUser extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_COOLCINEPLAN_TITLE_USER'), 'user.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_coolcineplan.user', $this->item->id);
		}
