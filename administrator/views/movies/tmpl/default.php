...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_coolcineplan&task=movies.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="movieList">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_coolcineplan&task=movie.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->movietitle); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->movietitle); ?>
				<?php endif; ?>
