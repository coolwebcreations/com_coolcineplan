 ...
 * @since  1.6
 */
class CoolcineplanControllerReservations extends CoolcineplanController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 * @since	1.6
	 */
	public function &getModel($name = 'Reservations', $prefix = 'CoolcineplanModel', $config = array())
	{
