...
<form action="<?php echo JRoute::_('index.php?option=com_coolcineplan&view=users'); ?>" method="post"
	...
	<?php echo JHtml::_('grid.sort', 'JPUBLISHED', 'a.state', $listDirn, $listOrder); ?>
			...
			<?php endif; ?>
							...
							<th class=''>
				<?php echo JHtml::_('grid.sort',  'COM_COOLCINEPLAN_USERS_ID', 'a.id', $listDirn, $listOrder); ?>
				</th>


							<?php if ($canEdit || $canDelete): ?>
					<th class="center">
				<?php echo JText::_('COM_COOLCINEPLAN_USERS_ACTIONS'); ?>
				</th>
				<?php endif; ?>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<?php if (isset($this->items[0]->state)) : ?>
					...
					<td class="center">
	<a class="btn btn-micro <?php echo $class; ?>" href="<?php echo ($canChange) ? JRoute::_('index.php?option=com_coolcineplan&task=user.publish&id=' . $item->id . '&state=' . (($item->state + 1) % 2), false, 2) : '#'; ?>">
	<?php if ($item->state == 1): ?>
	...
	<?php endif; ?>
				...
				<?php endif; ?>
				<a href="<?php echo JRoute::_('index.php?option=com_coolcineplan&view=userform&id='.(int) $item->id); ?>">
	...
	<?php if ($canCreate) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_coolcineplan&task=userform.edit&id=0', false, 2); ?>"
